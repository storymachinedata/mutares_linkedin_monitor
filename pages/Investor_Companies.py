...
st.markdown("<h1 style='text-align: center; color: cyan;'>Mutares Investor Companies LinkedIn Posts</h1>", unsafe_allow_html=True)
...
mutares_emp_path = 'https://phantombuster.s3.amazonaws.com/UhrenaxfEnY/MNVnuK5YOlIGE27ziKc98Q/mutares_investor_companies.csv'
