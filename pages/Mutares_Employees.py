...
st.markdown("<h1 style='text-align: center; color: cyan;'>LinkedIn posts from the employees of Mutares</h1>", unsafe_allow_html=True)
...
mutares_emp_path = 'https://phantombuster.s3.amazonaws.com/UhrenaxfEnY/xPHKPW8MW6YWbtRYiOHlwg/mutares_employees_posts.csv'
