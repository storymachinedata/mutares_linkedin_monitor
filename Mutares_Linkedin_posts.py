...
st.markdown("<h1 style='text-align: center; color: green;'>Mutares: Linkedin posts</h1>", unsafe_allow_html=True)
...
kath_brienne_path = 'https://phantombuster.s3.amazonaws.com/UhrenaxfEnY/wgLDQYhe3M5zGHtJbfp4Pw/mutares_posts.csv'



kath_brienne_main = read_file_sp(kath_brienne_path)
